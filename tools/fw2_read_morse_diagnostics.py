...
FIELDS = (
    ...
    "morse_attempt_count",
    "morse_attempt_raw_duration_ms",
    "morse_attempt_duration_ms",
    "morse_attempt_raw_mark_count",
    "morse_attempt_raw_gap_count",
    "morse_attempt_raw_mark_range_ms",
    "morse_attempt_raw_gap_range_ms",
