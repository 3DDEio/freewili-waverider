...
`/apps/Radio/WaveRider.uf2`, with embedded display name `WaveRider`. Current
v07 menus render the UF2 filename stem, so the friendly filename is part of
the user-facing menu contract rather than metadata alone.
